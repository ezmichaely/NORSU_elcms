...
<?php 
    $title = $page = $head_title = 'Manage - College';
...
<body class="container-fluid bg-primary">
        ...
        <div class="content bg-gray-200 p-3">
            ...
            <div class="card mt-3 p-3 shadow-sm">
                ...
                <div class="data-table table-responsive hasAddButton">
                    ...
                    <table id="CollegeTable" class="display table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>College</th>
    ...
    <?php include ROOT_PATH . '/app/includes/modals/ManageCollegeModal.php'?>
    <?php include ROOT_PATH . '/app/includes/script.php'?>

    <script>
    $(document).ready(function() {
        fetchCollege(0, 10000000);
        // FETCH ALL COLLEGES
        function fetchCollege(start, limit) {
            $.ajax({
                        ...
                        $("#CollegeTable").DataTable({
                            ...
                            initComplete: function() {
                                ...
                                btns.children(':first-child').append(
                                    '<i class="fas fa-plus"></i><span class="ms-1">ADD NEW college</span>'
                                );
