...
<?php 
    $title = 'Create Quiz'; $page = 'new quiz';
    $pagehas = array('authentication','post');
?>
    ...
    <main class="container-fluid fluid-padding my-2">
        <div class="container fluid-padding">
            ...
            <div class="d-flex justify-content-between align-items-center flex-row">
                ...
                <h3 class="fw-bold text-uppercase text-center">NEW quiz</h3>
            ...
            <div class="card my-2">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center flex-row flex-wrap">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-row lh-1">
                    ...
                    <div class="row m-0 g-0">
                        <div class="col-md-6 mx-auto">
                            <select id="question-type" class="form-select form-select-lg mb-0"
                                ...
                                <option value="0" hidden>Select Questionaire Type</option>
