...
<body class="container-fluid bg-primary">
                ...
                <div class="row g-3 justify-content-center">
                    <div class="col-lg-6">
                        <div class="card text-center border-primary shadow">
                            ...
                            <div class="card-body py-4">
                                <h1 class="card-title fw-bold"><?php echo $CountDepartmentFaculty; ?> </h1>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center border-primary shadow">
                            ...
                            <div class="card-body py-4">
                                <h1 class="card-title fw-bold"><?php echo $CountDepartmentClass; ?></h1>
                    ...
                    <div class="col-lg-6">
                        <div class="card text-center border-primary shadow">
                            ...
                            <div class="card-body py-4">
                                <h1 class="card-title fw-bold"><?php echo $CountDepartmentModule;?></h1>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        fetchDeptModuleApproval(0, 10000000);
        // FETCH ALL MajorS
        function fetchDeptModuleApproval(start, limit) {
            $.ajax({
                url: baseUrl + '/app/controllers/query/fetchDataTables.php',
                method: 'POST',
                dataType: 'text',
                data: {
                    fetchDeptModuleApproval: 'fetchDeptModuleApproval',
                    start: start,
                    limit: limit
                },
                success: function(response) {
                    if (response != "reachedMax") {
                        ...
                        start += limit;
                        fetchDeptModuleApproval(start, limit);
                    } else {
