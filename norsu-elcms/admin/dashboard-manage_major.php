...
<?php 
    $title = $page = $head_title = 'Manage - Major';
...
<body class="container-fluid bg-primary">
    ...
    <main id="dashboard" class="dashboard max">
        ...
        <div class="content bg-gray-200 p-3">
            ...
            <div class="card mt-3 p-3 shadow-sm">
                ...
                <div class="data-table table-responsive hasAddButton">
                    <table id="MajorTable" class="display table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>College</th>
        ...
        <?php include ROOT_PATH . '/app/includes/modals/ManageMajorModal.php'?>
    </main>
    ...
    $(document).ready(function() {
        fetchMajor(0, 10000000);
        // FETCH ALL MajorS
        function fetchMajor(start, limit) {
            $.ajax({
                        ...
                        $("#MajorTable").DataTable({
                            ...
                            initComplete: function() {
                                ...
                                btns.children(':first-child').append(
                                    '<i class="fas fa-plus"></i><span class="ms-1">ADD NEW Major</span>'
                                );
