...
<?php 
    $title = $page = $head_title = 'User - Department Head';
...
<body class="container-fluid bg-primary">
        ...
        <div class="content bg-gray-200 p-3">
            ...
            <div class="card mt-3 p-3 shadow-sm">
                ...
                <div class="data-table table-responsive hasNoAddButton">
                    <table id="DeptHeadTable" class="display table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>ID #</th>
                                <th>COLLEGE</th>
    ...
    $(document).ready(function() {
        fetchAllDeptHead(0, 10000000);
        // FETCH ALL MajorS
        function fetchAllDeptHead(start, limit) {
            $.ajax({
                url: baseUrl + '/app/controllers/query/fetchDataTables.php',
                method: 'POST',
                dataType: 'text',
                data: {
                    fetchAllDeptHead: 'fetchAllDeptHead',
                    start: start,
                    limit: limit
                },
