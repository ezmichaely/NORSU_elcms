...
<?php 
    $title = 'Edit Module'; $page = 'edit module';
...
<body class="">
    ...
    <main class="container-fluid fluid-padding my-2 h-88min">
        <div class="container fluid-padding">
            <h2 class="fw-bolder text-center font-title text-uppercase bg-warning rounded p-1">
                Modify your LEARNING MODULE
            </h2>

            <div class="hr-1 bg-gray-300 my-2"></div>

            <div class="card p-3 h-78min">
                <?php include ROOT_PATH . '/app/includes/forms/form-editModule.php'?>
            </div>
        </div>
    </main>
    ...
    <script>
    CKEDITOR.replace('EditModuleOutcome', {
        height: 400,
