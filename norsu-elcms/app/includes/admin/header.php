    ...
    <div class="user-action">
        <div class="user-action_profile">
            <button type="button" class="dropdown-btn d-flex flex-row align-items-center btn btn-primary dropdown-toggle p-1 
                    <?php if($page == 'profile') {echo 'active';}?>" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <ul class="dropdown-menu dropdown-menu-end p-0 overflow-hidden">
                <li class="dropdown-list">
                    <a href="<?php echo BASE_URL . '/' . $s_directory . '/profile.php'; ?>" class="dropdown-link fw-bold btn btn-outline-primary w-100 border-0 rounded-0 text-start px-3
